                                ...
                                if(task.isSuccessful()){
                                    ...
                                    FirebaseDatabase.getInstance().getReference("Users")
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                Toast.makeText(Register.this, "Clientul s-a inregistrat cu succes", Toast.LENGTH_LONG).show();
                                                finish();
                                            }
                                            else
                                            {
                                                Toast.makeText(Register.this, "Datele nu sunt introduse corespunzator", Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    });
                                }
                                else{
                                    Toast.makeText(Register.this, "Verificati conectarea la internet", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
